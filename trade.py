...
class TradeData(object):
    """"Trades received from i/p with span of multiple days"""
    ...
    def divide_trades_by_session(self):
        """filter out trades which are not valid and create a group based on day trade"""
        valid_trades = filter(
